...
Uint2048::Uint2048(const int& x) { //Constructeur à partir d'un entier.
  for (int i = 0; i < 32; i++) {
    u_[i] = 0;
  }
...
bool Uint2048::operator<(const Uint2048& other) const { //les objets appelés ne sont pas modifiés, juste lus. 
