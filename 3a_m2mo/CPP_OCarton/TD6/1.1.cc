...
Uint2048::Uint2048(int x) { //Constructeur à partir d'un entier.
  ...
  u_[31] = x; //Uint2048 est 64 entiers de 32 bits, int x est un entier de 32 bits ->'dans les unités', i.e. à la fin du tableau.
}

bool Uint2048::operator<(Uint2048 other) {
  return true;
